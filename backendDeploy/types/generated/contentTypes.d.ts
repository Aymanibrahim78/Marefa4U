...
export interface ApiBlogBlog extends Schema.CollectionType {
  ...
  attributes: {
    ...
    category: Attribute.Enumeration<
      ['Technology', 'Management', 'Education', 'Front End', 'Back End']
    > &
      Attribute.DefaultTo<'Technology'>;
    languageArabic: Attribute.Boolean & Attribute.DefaultTo<true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiCousrseCousrse extends Schema.CollectionType {
  ...
  attributes: {
    ...
    language: Attribute.String & Attribute.DefaultTo<'Arabic'>;
    level: Attribute.String & Attribute.DefaultTo<'Beginner'>;
    NumberOfStudents: Attribute.BigInteger;
    rating: Attribute.Decimal & Attribute.Required;
    Lessons: Attribute.DynamicZone<['lessons.lessons']>;
    showInSlider: Attribute.Boolean & Attribute.DefaultTo<false>;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::cousrse.cousrse': ApiCousrseCousrse;
